...
func (br *BugReporter) FetchUsersInfo(userIds []string) map[string]string {
...
func (br *BugReporter) FetchTagsInfo(tagIds []string) map[string]string {
...
func (br *BugReporter) AddTaskRecords(tasks []*phabricator.ManiphestSearchResponseItem) {
	userIds := []string{}
	tagIds := []string{}
	...
	usersInfo := br.FetchUsersInfo(userIds)
	tagsInfo := br.FetchTagsInfo(tagIds)
